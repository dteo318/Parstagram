...
public class ComposeFragment extends Fragment {
    ...
    private Button btnPostTakePic, btnPostSubmit;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btnPostTakePic = view.findViewById(R.id.btnPostTakePic);
        btnPostSubmit = view.findViewById(R.id.btnPostSubmit);

        btnPostTakePic.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void savePost(String description, ParseUser user, File photoFile) {
        ...
        post.saveInBackground(new SaveCallback() {
            ...
            public void done(ParseException e) {
                if (e != null) {
                    Log.e(TAG, "Post failed to save", e);
